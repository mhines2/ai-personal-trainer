#!/usr/bin/env python3
"""
This code file was the original version of the AI Personal Trainer chatbot so that users could interact with the 
AI trainer in a conversational manner through the command line. The chatbot would generate personalized workout plans.
"""
